...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>vehicle-card works!</p>\n");
...
/* harmony import */ var _vehicle_card_vehicle_card_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./vehicle-card/vehicle-card.component */ "./src/app/vehicle-card/vehicle-card.component.ts");
/* harmony import */ var _vehicle_table_vehicle_table_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./vehicle-table/vehicle-table.component */ "./src/app/vehicle-table/vehicle-table.component.ts");
/* harmony import */ var _shared_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./shared/navbar/navbar.component */ "./src/app/shared/navbar/navbar.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _vehicle_card_vehicle_card_component__WEBPACK_IMPORTED_MODULE_15__["VehicleCardComponent"],
            _vehicle_table_vehicle_table_component__WEBPACK_IMPORTED_MODULE_16__["VehicleTableComponent"],
            _shared_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_17__["NavbarComponent"],
...
VehicleCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./vehicle-card.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/vehicle-card/vehicle-card.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./vehicle-card.component.scss */ "./src/app/vehicle-card/vehicle-card.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VehicleTableDataSource", function() { return VehicleTableDataSource; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
const EXAMPLE_DATA = [
    { id: 1, oem: 'Hyundai', model: 'Kona', batteryRating: 39.2, slowCharge: 6.17, cost: 2400 },
    { id: 2, oem: 'Tata', model: 'Nexon', batteryRating: 30.2, slowCharge: 8.5, cost: 1701 },
    { id: 3, oem: 'Mahindra', model: 'E Verito', batteryRating: 21.2, slowCharge: 11.5, cost: 912 },
    { id: 4, oem: 'MG', model: 'ZS', batteryRating: 44.5, slowCharge: 6.5, cost: 2358 },
    { id: 5, oem: 'Mercedes', model: 'EQC', batteryRating: 80, slowCharge: 11, cost: 9930 },
];
/**
 ...
 */
class VehicleTableDataSource extends _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatTableDataSource"] {
    constructor() {
        super();
    ...
    getSortedData(data) {
        ...
        return data.sort((a, b) => {
            ...
            switch (this.sort.active) {
                ...
                case 'oem': return compare(a.oem, b.oem, isAsc);
                case 'model': return compare(a.model, b.model, isAsc);
                case 'batteryRating': return compare(a.batteryRating, b.batteryRating, isAsc);
                case 'slowCharge': return compare(a.slowCharge, b.slowCharge, isAsc);
...
/* harmony import */ var _vehicle_table_datasource__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./vehicle-table-datasource */ "./src/app/vehicle-table/vehicle-table-datasource.ts");
...
let VehicleTableComponent = class VehicleTableComponent {
    constructor() {
    ...
    getImagePath(imageId) {
        let imagePath = '/assets/img/' + imageId + '.jpg';
...
VehicleTableComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-vehicle-table',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./vehicle-table.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/vehicle-table/vehicle-table.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./vehicle-table.component.scss */ "./src/app/vehicle-table/vehicle-table.component.scss")).default]
    })
...
module.exports = __webpack_require__(/*! D:\tuna\ev-data-frontend\src\main.ts */"./src/main.ts");
